...
if html.encoding == 'ISO-8859-1':
    ...
    encode_content = html.content.decode(encoding, 'replace') #如果设置为replace，则会用?取代非法字符；
...
if contentUrl.encoding == 'ISO-8859-1':
    ...
    encode_content = contentUrl.content.decode(encoding, 'replace') #如果设置为replace，则会用?取代非法字符；
